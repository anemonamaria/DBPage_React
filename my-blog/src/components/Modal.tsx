...
interface ModalProps {
    ...
    articleForModal: Dispatch<SetStateAction<IArticle>>;
    isModalOpen: boolean;
...
function Modal(props: ModalProps) {
    const { articleForModal: setTempArticle, tempArticle, isModalOpen, visibleModal: setIsModalOpen, getArticlesFromServer } = props;
